...
class elements
{
    public function navBar($params = array())
    {
        ...
        return '
            <div class="tool_bar noprint">
                    ...
                    <div class="doc_title_container" aria-label="Thank you for signing: Contract of Work for Website Design and Development">
                        <h4 class="doc_title"><span style="color: '.$params['color'].'; font-size: 18px;"><i class="'.$params['icon'].'"></i></span> '. $params['title'].'</h4>
                    </div>
                    <div class="docs_icon">
                        <div class="tooltip">
    ...
    public function accountPanel($params = array())
    {
        return '
                    ...
                    <div class="account_avatar_panel">
                        ...
                        <div class="links_container">
                            <div style="display: inline-block; margin: 20px">
                                <a href="privacy.php" style="text-decoration: none; margin: 0 5px; 0 5px;">Privacy Policy</a>
                                <span>•</span>
                                <a href="terms.php" style="text-decoration: none; margin: 0 5px; 0 5px;">Terms & Conditions</a>
                            </div>
                        </div>
